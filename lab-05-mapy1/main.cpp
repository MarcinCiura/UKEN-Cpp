...
int main() {
  ...
  const auto [najpopularniejsze_nazwisko, liczba_osob] =
      wyznacz_najpopularniejsze_nazwisko(studenci);
  cout << "najpopularniejsze nazwisko: " << najpopularniejsze_nazwisko << '\t'
       << liczba_osob << endl;
  {
  ...
  cout << "liczba studentow bez ocen: " << policz_studentow_bez_ocen(studenci)
       << endl;
}
